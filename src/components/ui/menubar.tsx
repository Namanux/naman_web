...
//import { Check, ChevronRight, Circle } from "lucide-react" original path bellow is fixed path to fix the error.
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex h-30 items-center space-x-1 rounded-md border border-slate-200 bg-white p-1 dark:border-slate-800 dark:bg-slate-950",
      className
    )}
    {...props}
  />
